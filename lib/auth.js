...
export const authOptions = {
  ...
  callbacks: {
      ...
      if (account.provider === "google") {
        try {
          ...
          if (existingUser) {
            ...
            if (googleAccount) {
              return true; // Google already linked
            }
    ...
    // SIMPLIFIED REDIRECT - Remove the questionnaire check here
    async redirect({ url, baseUrl }) {
      // Always redirect to Allcourse after auth
      // We'll handle questionnaire redirect differently
