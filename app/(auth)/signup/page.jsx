          ...
          >
            {!isSuccess ? (
              <>
                ...
                {/* Google Sign Up Button - Outside the form */}
                <button
                  onClick={handleGoogleSignIn}
                  disabled={googleLoading || emailLoading}
                  className="w-full flex items-center justify-center gap-2 bg-white border border-muted p-2 rounded-md hover:bg-muted transition disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  <img
                    src="/google.svg"
                    alt="Google icon"
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <input
                    ...
                    className="w-full p-3 border border-muted rounded-md focus:outline-none focus:ring-2 focus:ring-primary disabled:opacity-50"
